						...
						<div class="row align-items-center justify-content-center d-flex">
							<nav id="nav-menu-container" style="font-size:16px">
								<ul class="nav-menu">
									...
									<li id="rescue"><a href="about.html">救援</a></li>
									<li id="adopt"><a href="service.html">認養</a></li>
									<li class="menu-has-children" id="missing"><a href="training.html">失蹤</a>
								    	<ul>
...
<!-- 						        	<span class="like-btn-fix" id="like-btn-fix" style="display:inline; padding-right:30px"></span> -->
						...
						<div class="col-lg-11 col-sm-11 menu-top-right">
							...
							<div align="center"  style="font-size:14px">
								...
								%>
								<a href="<%=request.getContextPath()%>/front-end/members/mem.do?action=logout" style="font-size:14px"><img style="width:40px;height:40px" class="img-fluid" src="<%=request.getContextPath()%>/images/logout.png" data-toggle="tooltip" data-placement="left" title="登出">登出</a><br>
