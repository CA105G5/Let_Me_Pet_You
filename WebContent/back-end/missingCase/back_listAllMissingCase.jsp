                                ...
                                <table style="text-align:center" id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
										...
										<c:forEach var="missingCaseVO" items="${list}">
												...
												<tr>
													<td><%=no %></td>
													<td style=" margin-bottom: auto"><a
												href="<%=request.getContextPath()%>/front-end/missingCase/miss.do?action=getOne_For_Display&missing_case_id=${missingCaseVO.missing_case_id}">${missingCaseVO.missing_case_id}</a></td>
													<td style=" margin-bottom: auto">${missingCaseVO.missing_name}</td>
													<td style=" margin-bottom: auto">
														${memSvc.getOneMem(missingCaseVO.memb_id).memb_nick}
													</td>
