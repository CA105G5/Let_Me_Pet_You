...
<body>
	...
	<jsp:include page="/back-end/missingCase/back_missingCase_Header.jsp" flush="true" />
                                ...
                                <c:forEach var="missingCaseVO" items="${list}"
                                            begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
                                                <tr>
                                                    ...
                                                    <td> <span class="product">${missingCaseVO.missing_type}</span> </td>
                                                    <td><span class=""><fmt:formatDate value="${missingCaseVO.missing_date}" pattern="yyyy-MM-dd"/></span></td>
                                                    <td>
