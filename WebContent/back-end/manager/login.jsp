    ...
    <FORM METHOD="post" ACTION="manager.do" >
        <div class="container">
			...
			<div class="page-header">
			  <h1 align="center">LET ME PET YOU</h1>
			  <h1 align="center">管理員登入系統</h1>
			</div>
			<table class="table table-bordered table-striped table-hover table-condensed">
			<tr><td>帳號:</td><td><input type="text" name="ma_acc"></td></tr>
			<tr><td>密碼:</td><td><input type="password" name="ma_psw"></td></tr>
