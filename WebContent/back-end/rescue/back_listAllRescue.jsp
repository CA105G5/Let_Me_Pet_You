...
<body>
	...
	<jsp:include page="/back-end/rescue/back_rescue_header.jsp"
		flush="true" />
...
<%-- 														value="${rescueVO.missing_case_id}">上架</option> --%>
<%-- 													<option value="${rescueVO.missing_case_id}">下架</option> --%>
<!-- 											</select></td> -->
										</tr>
									</c:forEach>
								</tbody>
