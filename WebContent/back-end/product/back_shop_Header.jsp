...
<%--                             <li><i class="fa fa-id-badge"></i><a href="<%=request.getContextPath()%>/back-end/product/back_Money_Don_Total.jsp">愛心捐款查詢</a></li> --%>
                     ...
                     <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">志工修改</a></li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" a href="<%=request.getContextPath()%>/back-end/manager/back_end_index.jsp"><img src="<%=request.getContextPath()%>/backend_UI_template/images/logo-2.png" alt="Logo" height="42"></a>
