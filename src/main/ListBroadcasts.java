...
public class ListBroadcasts {
	...
	static String liveStreamId = "";
	static String liveStreamTitle = "";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //取得正在直播
            liveBroadcastRequest.setBroadcastType("all").setBroadcastStatus("active");
            ...
            for (LiveBroadcast broadcast : returnedList) {
                ...
                System.out.println("\n-------------------------------------------------------------\n");
                liveStreamId = broadcast.getId();
                liveStreamTitle = broadcast.getSnippet().getTitle();
            }
    ...
    public static String getLiveId() {
    	return ListBroadcasts.liveStreamId;
    }
    
    public static String getTitle() {
    	return ListBroadcasts.liveStreamTitle;
    }
}