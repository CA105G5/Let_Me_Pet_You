...
public class ListHistory {
	...
	static List<String> historyStreamId = new ArrayList<String>();
	static List<String> historyStreamTitle = new ArrayList<String>();
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //取得正在直播
            liveBroadcastRequest.setBroadcastType("all").setBroadcastStatus("completed");
            ...
            for (LiveBroadcast broadcast : returnedList) {
                ...
                System.out.println("\n-------------------------------------------------------------\n");
                historyStreamId.add(broadcast.getId());
                historyStreamTitle.add(broadcast.getSnippet().getTitle());
            }
    ...
    public static List<String> getHistoryId() {
    	return ListHistory.historyStreamId;
    }
    
    public static List<String> getTitle() {
    	return ListHistory.historyStreamTitle;
    }
}